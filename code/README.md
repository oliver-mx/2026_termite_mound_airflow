...
NOTE: Due to the large range of input parameters, not all initial states are perfectly chosen for each mound geometry.
...
NOTE: This repository already provides the output generated by `r-h_simulations.jl`.
